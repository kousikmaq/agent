"""Canonical CSV schema registry.

Single source of truth mapping each :class:`FactoryState` collection to its CSV
file and model class. Shared by the CSV adapter (read) and the snapshot manager
(write). Routings are handled separately because they nest their operations.
"""
...
ROUTING_HEADER_FIELDS = ("routing_id", "product_id", "version")
